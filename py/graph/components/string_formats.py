"""
This module contains various methods for formatting specific strings. The methods typically accept a value, and return
its formatted string counterpart.
...
def hod(hour_of_day: int) -> str:
    """2-digit 0-23h string representation of hour of day"""
    return f"{hour_of_day:0>2}h"


def dow(_dow: int) -> str:
    """Shortened day of week"""
    return _dow[day_of_week]


def day_of_week(day_of_week: int) -> str:
    """Full day of week"""
    return _days_of_week[day_of_week]
...
_int_abbreviations = [
    ...
    Multiplier(multiplier=pow(10, 3), abbreviation='K', threshold=1000000),
